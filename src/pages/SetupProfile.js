...
import { GraduationCap, School, BookOpen, UserCircle, Loader2, Info, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#FDFDFB] flex items-center justify-center p-6 text-slate-800">
      <div className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,33,71,0.05)] max-w-2xl w-full p-10 border border-slate-100 overflow-hidden relative">
        ...
        <header className="mb-12 text-center">
          <h1 className="font-serif text-5xl font-bold text-[#002147] mb-4 tracking-tight">
            Join the Network
          </h1>
          <p className="text-slate-500 text-lg max-w-sm mx-auto leading-relaxed">
            Personalize your experience to connect with the right people.
          </p>
        </header>
                ...
                return (
                  <button
                    ...
                    className={`group relative p-6 rounded-2xl border-2 text-left transition-all duration-300 transform active:scale-[0.97] ${
                      isSelected
                        ? "border-[#002147] bg-[#002147]/[0.02] shadow-[0_10px_20px_rgba(0,33,71,0.06)]"
                        : "border-slate-100 bg-slate-50/50 hover:border-slate-200 hover:bg-white"
                    }`}
                  >
                    <div className={`p-3.5 rounded-xl w-fit mb-5 transition-all ${isSelected ? "bg-[#002147] text-white rotate-3" : "bg-white text-slate-400 group-hover:text-[#002147] group-hover:-rotate-3"}`}>
                      <Icon className="w-7 h-7" />
                    </div>
                    <div>
                      <h3 className={`font-bold text-xl mb-1.5 ${isSelected ? "text-[#002147]" : "text-slate-700 font-semibold"}`}>
                        {role.label}
                      </h3>
                    ...
                    {isSelected && (
                      <div className="absolute top-5 right-5">
                        <div className="bg-[#002147] rounded-full p-1">
            ...
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-700 fill-mode-both">
              ...
              <div className="pt-8">
                <Button
                  ...
                  className="w-full bg-[#002147] text-white hover:bg-[#002147]/90 h-16 rounded-2xl text-xl font-bold shadow-xl shadow-[#002147]/20 transition-all duration-300 hover:-translate-y-1 active:scale-[0.98] disabled:opacity-50 disabled:translate-y-0"
                >
                  {loading ? (
